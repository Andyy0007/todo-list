...
let todoInput = document.querySelector(".input");//select then add event listner to it
...
//here e is capturing the event as add button is in the form tag which means it will submit after we click on add 
